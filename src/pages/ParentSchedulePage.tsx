...
import { useChildWeeklySchedule } from '../hooks/useChildWeeklySchedule'
...
const ParentSchedulePage = () => {
  const { data: dashboardData } = useParentDashboardQuery()
  ...
  } = useChildWeeklySchedule(selectedChildId, weekStartDate.toISOString(), {
    timezone,
    days: 7,
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-12 text-center shadow-sm">
          ...
          <p className="text-gray-600">
            Vui lòng thêm thông tin con trong phần Cài đặt
          </p>
        </div>
      </div>
    )
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <p className="text-sm font-medium text-blue-600">Lịch học của con</p>
          <h1 className="text-2xl font-bold text-gray-900">
            Lịch học, lịch thi theo tuần
          </h1>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 shadow-sm hover:bg-gray-50"
            >
              {children.map((child) => (
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
        {isLoadingWeekly ? (
          <div className="flex flex-col items-center justify-center gap-2 py-16 text-gray-500">
            ...
            <p className="text-sm">
              Đang tải lịch học của {selectedChild?.name}...
            </p>
          </div>
        ) : (
          <>
            <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-semibold text-gray-900">
                  Lịch học của {selectedChild?.name}
                </h2>
              </div>
