                                  ...
                                  >
                                    ...
                                    {session.type &&
                                      typeStyles[session.type] && (
                                        <span
                                          className={`inline-flex items-center gap-0.5 rounded-full px-1.5 py-0.5 text-[9px] sm:text-[10px] font-medium ${typeStyles[session.type].bg} ${typeStyles[session.type].text}`}
                                        >
                                          {(() => {
                                            const TypeIcon =
